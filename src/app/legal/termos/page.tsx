...
export default function Page() { return <InfoPage eyebrow="Legal · atualizados em 18/08/2026" title="Termos de uso" description="Estas condições organizam o uso da plataforma e as compras realizadas na Heca - Store. Ao usar o site, você concorda em agir de forma lícita e fornecer informações verdadeiras." sections={[
  ...
  { title: "Uso permitido", text: "Não é permitido tentar acessar contas ou áreas restritas, interferir no funcionamento, explorar falhas, automatizar uso abusivo ou utilizar conteúdo e marca da Heca - Store sem autorização, ressalvados usos admitidos por lei." },
