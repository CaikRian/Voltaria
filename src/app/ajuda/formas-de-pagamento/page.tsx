...
export default function Page() { return <InfoPage eyebrow="Pagamento seguro" title="Você escolhe como pagar" description="O pagamento é processado no ambiente do Mercado Pago. A Voltaria recebe o status da transação, sem armazenar os dados completos do seu cartão." action={{ href: "/produtos", label: "Ver produtos" }} sections={[
