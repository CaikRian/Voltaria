  ...
  return (
    <form action={action} className="grid gap-6 sm:grid-cols-2">
      ...
      <section className="grid gap-4 sm:col-span-2 sm:grid-cols-2">
        ...
        <label className="flex flex-col gap-1.5"><span className="text-sm font-medium">Como conheceu a Heca Store?</span><select name="referralSource" required defaultValue="" className={inputClass}><option value="" disabled>Selecione uma opção</option><option>Busca na internet</option><option>Instagram ou TikTok</option><option>Indicação de alguém</option><option>Publicidade</option><option>Outro</option></select><FieldError errors={fe.referralSource} /></label>
