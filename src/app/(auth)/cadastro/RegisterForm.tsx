  ...
  return (
    <form action={action} className="grid gap-6 sm:grid-cols-2">
      ...
      <section className="grid gap-4 border-t border-line pt-5 sm:col-span-2 sm:grid-cols-2">
        ...
        <label className="flex flex-col gap-1.5"><span className="text-sm font-medium">UF</span><input name="state" maxLength={2} required className={`${inputClass} uppercase`} placeholder="SP" /><FieldError errors={fe.state} /></label>
      </section>
