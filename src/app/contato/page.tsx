...
export default function Page() { return <InfoPage eyebrow="Fale com a Voltaria" title="Ajuda no lugar certo, sem perder o contexto" description="Escolha o canal de acordo com sua necessidade. Assuntos de pedidos ficam registrados na própria compra para oferecer um atendimento mais seguro." action={{ href: "/conta/pedidos", label: "Acessar meus pedidos", secondary: "Abra o pedido e solicite atendimento." }} sections={[
  ...
  { title: "Antes de chamar", text: "Tenha o número do pedido em mãos e não envie senhas ou dados completos de cartão. A Voltaria nunca precisa dessas informações para atender você." }
]} />; }
